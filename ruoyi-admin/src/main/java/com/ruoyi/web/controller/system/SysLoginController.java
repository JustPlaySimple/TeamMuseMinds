...
public class SysLoginController
{
    ...
    public AjaxResult systemLogin(@RequestBody LoginBody loginBody)
    {
        AjaxResult ajax = AjaxResult.success();
        // 生成令牌
        String token = loginService.systemLogin(loginBody.getEmail(), loginBody.getPassword(),loginBody.getCode(),
                loginBody.getUuid());
        return AjaxResult.success("token", token);
    }
    ...
    public AjaxResult preLogin(@RequestBody LoginBody loginBody)
    {
        AjaxResult ajax = AjaxResult.success();
        // 生成令牌
        loginService.preLogin(loginBody.getEmail(), loginBody.getPassword(),
                loginBody.getUuid());
        return ajax;
    }
    ...
    public AjaxResult sendOtp(@RequestBody LoginBody loginBody)
    {
        AjaxResult ajax = AjaxResult.success();
        // 生成令牌
        loginService.sendOtp(loginBody.getEmail());
        return ajax;
    }
